...
STREAM_SITE = (environ.get('STREAM_SITE', 'paisakamalo.in/api'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001878965765') # support group id ( make sure bot is admin )
...
# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'paisakamalo.in/api')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+02QarU6rhSsxZGIx')
...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1001780805995")).split())) 
